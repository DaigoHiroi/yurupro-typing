...
export default function PlayEndlessOne() {
  const isRandom = false;
  const isEndless = true;
  const isCrazy = false;
  const file_path = Data.data.level_4.file_path;
  const vocabulary_data= Data.data.level_4.vocabulary_data;
      ...
      <>
        ...
        <div className="grid-cols-12 gap-4">
          <h1 className="font-bold text-center text-5xl text-blue-900">
            Level 4 <span className="text-yellow-700 text-4xl">【Endless1】</span>
          </h1>
