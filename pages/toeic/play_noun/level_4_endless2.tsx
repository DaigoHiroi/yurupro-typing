...
export default function PlayEndlessTwo() {
  const isRandom = true;
  const isEndless = true;
  const isCrazy = false;
  const file_path = Data.data.level_4.file_path;
  const vocabulary_data= Data.data.level_4.vocabulary_data_rdm;
  ...
  return (
      <>
        <Head>
          <title>Yuru-Pro_Typing 名詞 level 4</title>
        ...
        <div className="grid-cols-12 gap-4">
          <h1 className="font-bold text-center text-5xl text-blue-900">
            Level 4 <span className="text-yellow-700 text-4xl">【Endless2】</span>
          </h1>
